...
class BallScene: SKScene, SKPhysicsContactDelegate {
    ...
    let MOVEMENT_ACTION_NAME = "movement_action"
    ...
    override func touchesBegan(touches: Set<NSObject>, withEvent event: UIEvent) {
        ...
        if let myAction = action {
            ...
            mainNode!.runAction(SKAction.repeatActionForever(myAction), withKey: MOVEMENT_ACTION_NAME)
        }
    }
    ...
    override func touchesEnded(touches: Set<NSObject>, withEvent event: UIEvent) {
        mainNode!.removeActionForKey(MOVEMENT_ACTION_NAME)
    }
